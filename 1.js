...
let a = func("zhangsan"); // 常规方式调用函数
console.log(a); // zhangsan global_name

let b = func.call(person, "zhangsan"); // 设置this为person
console.log(b); // zhangsan person_name
let c = func.call();
console.log(c); // undefined global_name
let d = func.call(null, "zhangsan"); // this为null
console.log(d); // zhangsan global_name
let e = func.call(undefined, "zhangsan"); // this为undefined
console.log(e); // zhangsan global_name

//严格模式下
("use strict");
func.call(); // 不能读undefined的lastName属性
func.call(null, "zhangsan"); // 不能读null的lastName属性
func.call(undefined, "zhangsan"); // 不能读undefined的lastName属性
...
// 直接在person对象上调用方法
person.getNameAndAge("zhangsan"); // zhangsan 20
// 将方法的引用赋值给变量 nameAndAge
const nameAndAge = person.getNameAndAge;
// 通过引用nameAndAge，调用赋值给它的函数
nameAndAge("zhangsan"); // zhangsan undefined （函数在全局作用域被调用）
const boundNameAndAge = nameAndAge.bind(person, "zhangsan");
boundNameAndAge(); // zhangsan 20 (bind()创建一个新函数，将this值绑定到person对象）
// 不带任何参数绑定
const boundNameAndAge = nameAndAge.bind();
boundNameAndAge("zhangsan"); // zhangsan undefined
// 将 'this' 设置为 'undefined'
const boundNameAndAge = nameAndAge.bind(undefined, "zhangsan");
boundNameAndAge(); // zhangsan undefined
// 将 'this' 设置为 'null'
const boundNameAndAge = nameAndAge.bind(null, "zhangsan");
boundNameAndAge(); // zhangsan undefined
